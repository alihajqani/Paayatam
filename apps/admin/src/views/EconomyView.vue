    ...
    <StateBlock :state="state" :error-text="error" :rows="6" @retry="load">
      <div v-if="report" class="flex flex-col gap-5">
        ...
        >
          ...
          <p class="mt-2">
            تا وقتی رویدادها پر نمی‌شوند، مسئله قیمت نیست؛ کمبود عرضه است. هر سکه‌ای که در این وضعیت
            از بازار بگیرید، از نقدینگی همان بازار گرفته‌اید. کاری که درست است: هزینهٔ درخواست شرکت
            را موقتاً پایین بیاورید و همهٔ انرژی را روی ساختن رویداد بگذارید.
          </p>
        </section>
