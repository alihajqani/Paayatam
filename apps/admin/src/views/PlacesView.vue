...
const launchBody = computed(() => {
  ...
  return (
    ...
    'فرستاده می‌شود که این شهر را در پروفایلشان دارند. این پیام برای هر شهر فقط یک بار ' +
    ...
    notice.value =
      updated.isLaunched !== isLaunched
        ...
        : isLaunched
          ...
          : `«${city.nameFa}» بسته شد. پروفایل‌ها دست‌نخورده می‌مانند و در فهرست انتظار شمرده می‌شوند.`;
    await loadCities();
  } catch (cause) {
                  ...
                  <span
                    ...
                    :title="
                      city.isLaunched
                        ...
                        : 'قابل انتخاب است، ولی هنوز رویدادی اینجا نیست — پروفایل‌ها در فهرست انتظار می‌شمارند'
                    "
                  >
