...
<template>
  <div class="flex flex-col gap-5">
    <section class="rounded-xl border border-line bg-surface p-4 text-sm leading-relaxed">
      <p>
        فهرست تفریحاتی که میزبان‌ها رویداد خود را زیر آن ثبت می‌کنند. افزودن، ویرایش، مرتب‌سازی و
      ...
      <p class="mt-2 text-ink-soft">
        ...
        به‌جای حذف آن را غیرفعال کنید تا رویدادهای ثبت‌شده دست‌نخورده بمانند.
      </p>
      <p class="mt-2 text-ink-soft">
        گزینهٔ «عنوان دلخواه» همان رفتار «سایر» است: میزبان می‌تواند نوع تفریح خود را بنویسد و آن
        متن مثل عنوان رویداد از فیلتر واژگان ممنوع عبور می‌کند.
      </p>
    </section>
        ...
        <table class="w-full min-w-[52rem] text-sm">
          <thead class="border-b border-line text-start text-xs text-ink-faint">
            <tr>
              ...
              <th class="px-4 py-3 text-start">رویدادها</th>
              ...
              <td class="px-4 py-3 text-end">
                <div class="flex items-center justify-end gap-3">
                  ...
                  <button
                    ...
                    :title="
                      tag.eventCount > 0
                        ? 'این تفریح در رویدادهای ثبت‌شده استفاده شده است؛ آن را غیرفعال کنید.'
                        : 'حذف'
                    "
                    @click="deleting = tag"
                  >
